...
dependents_1.registerComponentController('gesture', dependents_1.Gesture);
var ViewLayer = /** @class */ (function (_super) {
    ...
    ViewLayer.prototype.getOptions = function (props) {
        ...
        var interactions = util_1.reduce(util_1.flatten(util_1.map([options, defaultOptions, curOptions, props], function (src) { return util_1.get(src, 'interactions', []); })), function (result, cur) {
